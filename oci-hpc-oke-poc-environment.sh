...
# Creates compartment
# Groups - OCI-HPC-OKE-POC-Group, 
# adds user from OCI Shell session running script
# Creates policies for HPC OKE deployment
...
HPC_GROUP_NAME="OCI-HPC-OKE-POC-Group"
HPC_POLICY_NAME="OCI-HPC-OKE-Deployment-Policies"
...
delete_resource_manager() {
    ...
    SEARCH_TERM="oke-gpu-rdma-quickstart.zip"
    DRY_RUN=false
...
if [ -n "$EXISTING_POLICY" ]; then
    ...
    POLICY_STATEMENTS='[
        "Allow group '$HPC_GROUP_NAME' to manage instance-family in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to use subnets in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage virtual-network-family in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to inspect compartments in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to use vnics in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to use network-security-groups  in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to use private-ips  in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage public-ips  in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage volume-family in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage cluster-family in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage vcns in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage subnets in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage internet-gateways in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage nat-gateways in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage route-tables in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage security-lists in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to inspect clusters in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to use cluster-node-pools in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to read cluster-work-requests in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to manage service-gateways in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to use cloud-shell in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to read vaults in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to read keys in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to use compute-capacity-reservations in compartment '$POC_COMPARTMENT_NAME'",
        "Allow group '$HPC_GROUP_NAME' to read metrics in compartment '$POC_COMPARTMENT_NAME'"
    ]'
    ...
    CREATE_POLICY_RESULT=$(oci iam policy create \
        ...
        --description "Policies for HPC OKE deployment in POC compartment" \
